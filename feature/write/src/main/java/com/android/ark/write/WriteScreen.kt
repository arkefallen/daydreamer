...
import com.android.ark.ui.components.GalleryImage
import com.android.ark.model.Mood
import com.android.ark.ui.components.GalleryState
        ...
        WriteContent(
            ...
            onImageClicked = { selectedImage ->
                ...
                galleryState.images.forEach { galleryImage ->
                    uiState.images?.add(galleryImage)
                }
            }
        )

        // TODO: implement feature to see all added gallery image by swiping to left or right
        AnimatedVisibility(visible = selectedGalleryImage != null && !uiState.images.isNullOrEmpty()) {
            selectedGalleryImage?.let { image ->
                Dialog(onDismissRequest = { selectedGalleryImage = null }) {
                    ZoomableImage(
                        ...
                        galleries = uiState.images!!.toList()
                    )
                }
            }
