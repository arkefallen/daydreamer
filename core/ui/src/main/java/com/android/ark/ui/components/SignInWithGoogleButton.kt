...
fun SignInWithGoogleButton(
    ...
    var buttonText : String by remember { mutableStateOf(primaryText) }
...
@Preview
@Composable
fun SignInWithGoogleButtonLoadingPreview() {
    SignInWithGoogleButton(onClick = {}, loadingState = true)
}